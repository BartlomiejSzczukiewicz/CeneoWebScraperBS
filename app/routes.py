...
from app.utils import extract_content, score, transformations, translate, selectors
        ...
        if response.status_code == requests.codes['ok']:
            ...
            if opinions_count:
                ...
                while(url):
                    ...
                    page_dom = BeautifulSoup(response.text, 'html.parser')
                    opinions = page_dom.select('div.js_product-review') #reminder functions for extraction and statistics
